...
// import './Footer.css'; // Import CSS for styling if needed
    ...
    <footer style={footerStyle}>
      <div style={containerStyle}>
        ...
        <ul style={footerLinksStyle}>
          ...
          <li style={footerLinkItemStyle}><a href="/contact-us" style={footerLinkStyle}>ContactUs</a></li>
          <li style={footerLinkItemStyle}><a href="/Review" style={footerLinkStyle}>Review</a></li>
          {/* <li style={footerLinkItemStyle}><a href="/CategoryPage" style={footerLinkStyle}>Category</a></li> */}
